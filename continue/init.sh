...
# VANILLA_REMOTE_URL="https://raw.githubusercontent.com/costa-security/install/refs/heads/main/continue/config.yaml"
REMOTE_URL="https://ai.costa.app/api/v1/setup/continue/config.yaml"
